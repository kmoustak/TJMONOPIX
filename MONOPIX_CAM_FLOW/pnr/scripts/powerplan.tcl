...
sroute -connect {corePin} -nets { GNDP VDDP }  -layerChangeRange { M1 TOP_M }   

addStripe -skip_via_on_wire_shape Noshape -block_ring_top_layer_limit TOP_M -max_same_layer_jog_length 0.88 -padcore_ring_bottom_layer_limit M4 -set_to_set_distance 25 -skip_via_on_pin Standardcell -stacked_via_top_layer TOP_M -padcore_ring_top_layer_limit TOP_M -spacing 1 -switch_layer_over_obs 1 -merge_stripes_value 0.84 -layer TOP_M -block_ring_bottom_layer_limit M4 -width {10 } -nets {VDDP GNDP} -stacked_via_bottom_layer M1

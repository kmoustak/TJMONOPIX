...
create_clock -name CLK_CONF -period 25 [get_ports CLK_CONF_PAD]
...
set_input_delay 15 -clock CLK_CONF -max [get_ports SI_CONF_PAD]
set_input_delay 0 -clock CLK_CONF -min [get_ports SI_CONF_PAD]

set_input_delay 15 -clock CLK_CONF -max [get_ports LD_CONF_PAD]
set_input_delay 0 -clock CLK_CONF -min [get_ports LD_CONF_PAD]
    
set_input_delay 15 -clock CLK_BX -max [get_ports RESET_BCID_PAD]
set_input_delay 0 -clock CLK_BX -min [get_ports RESET_BCID_PAD]

set_input_delay 15 -clock CLK_BX -max [get_ports READ_*]
set_input_delay 0 -clock CLK_BX -min [get_ports READ_*]

set_input_delay 15 -clock CLK_BX -max [get_ports FREEZE_*]
set_input_delay 0 -clock CLK_BX -min [get_ports FREEZE_*]

set_output_delay 10 -clock CLK_CONF -max [get_ports SO_CONF_PAD]
set_output_delay 4 -clock CLK_CONF -min [get_ports SO_CONF_PAD]
...
set_output_delay 4 -clock CLK_BX -min -add_delay [get_ports TOKEN_*]
